// ============================================================================
// SideNav — PulseOps V1 Layout System
//
...
//
// ARCHITECTURE: Stateless layout component. All data flows via props.
// Collapse state can be controlled externally or managed internally.
//
// USAGE:
//   <SideNav
//     title="Admin"
...
//
// DEPENDENCIES:
//   - @shared/config/uiText.json → Collapse/expand labels
...
const txt = uiText.sideNav.header;
